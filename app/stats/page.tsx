...
import { Card, CardActions, CardContent, CardHeader, CircularProgress, Grid, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, } from '@mui/material';
				...
				<>
					<Grid container spacing={2} >
						<Grid item sx={{width:'100%'}} >
							...
							<Card sx={{ maxWidth: 345, width: '100%', display: 'inline-block', '@media (min-width: 600px)': { display: 'inline-block' } }}>
								<CardHeader
										sx={{
